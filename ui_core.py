...
# ---------------------------------------------------------------------------
# Session state — backed by the shared context_store singleton so that
# task_executor, session_memory, and ui_core all see the same values.
# ---------------------------------------------------------------------------
session: dict = _cs._STORE
